...
def plot_matches(
    ...
    # img2 [256,256]->[256,256,3]
    # if image2.ndim == 2:
    #     image2 = np.dstack((image2,) * 3)

    # if image1 or image2 is gray, convert to 3 channel
    ...
    if plot_matche_points:
        ...
        ax.scatter(
            keypoints2[:, 0] + offset[1],
            keypoints2[:, 1] + offset[0],
            facecolors="none",
            edgecolors=keypoints_color,
            marker=".",
        )
    ...
    if matchline == True:
        for i in range(matches.shape[0]):
            ...
            ax.plot(
                (keypoints1[idx1, 0], keypoints2[idx2, 0] + offset[1]),
                (keypoints1[idx1, 1], keypoints2[idx2, 1] + offset[0]),
                "-",
                color=color,
                linewidth=matchlinewidth,
                marker="+",
                markersize=8,
            )
...
def plot_matches2(
    ...
    if matchline == True:
        for i in range(keypoints1.shape[0]):
            ...
            ax.plot(
                (keypoints1[i, 0], keypoints2[i, 0] + offset[1]),
